TASKS = {
    ...
    "здоров": [
        "🌱 «Мой рост»: Напиши 3 вещи, которые ты теперь знаешь о себе и которых не знал(а) до расставания.",
        "🗺️ «Карта желаний»: Опиши 3 цели на ближайшие полгода — любые, от маленьких до больших.",
        "💞 «Благодарность прошлому»: Напиши, за что ты благодарен(на) этим отношениям. Без обесценивания.",
        "🎯 «Новая глава»: Какое одно действие ты можешь сделать сегодня, чтобы приблизиться к тому, кем хочешь стать?",
        "📝 «Рефлексия»: Что из прожитого опыта ты хотел(а) бы взять с собой в будущие отношения, а что — оставить?",
    ],
}
